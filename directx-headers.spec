...
Source0  : https://github.com/microsoft/DirectX-Headers/archive/v1.613.1/DirectX-Headers-1.613.1.tar.gz
...
%prep
%setup -q -n DirectX-Headers-1.613.1
cd %{_builddir}/DirectX-Headers-1.613.1
pushd ..
cp -a DirectX-Headers-1.613.1 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711976228
