...
Version  : 1.610.2
Release  : 9
URL      : https://github.com/microsoft/DirectX-Headers/archive/v1.610.2/DirectX-Headers-1.610.2.tar.gz
Source0  : https://github.com/microsoft/DirectX-Headers/archive/v1.610.2/DirectX-Headers-1.610.2.tar.gz
...
%prep
%setup -q -n DirectX-Headers-1.610.2
cd %{_builddir}/DirectX-Headers-1.610.2
%patch1 -p1
pushd ..
cp -a DirectX-Headers-1.610.2 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684423354
