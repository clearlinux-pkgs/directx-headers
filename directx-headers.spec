...
Source0  : https://github.com/microsoft/DirectX-Headers/archive/v1.615.0/DirectX-Headers-1.615.0.tar.gz
...
%prep
%setup -q -n DirectX-Headers-1.615.0
cd %{_builddir}/DirectX-Headers-1.615.0
pushd ..
cp -a DirectX-Headers-1.615.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738271960
